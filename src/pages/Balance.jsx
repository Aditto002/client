...
const Balance = () => {
  ...
  const fetchpdf = async () => {
    try {
      ...
      const response = await axios.get(
        "https://bebsa-backend.vercel.app/api/mobileAccounts/download-pdf",
        {
          params: params,
        }
      );
  ...
  const handleUpdateSubmit = async () => {
    try {
      ...
      await axios.put(
        `https://bebsa-backend.vercel.app/api/debit/${updateData._id}`,
        updateData
      );
  ...
  const confirmDelete = async () => {
    try {
      ...
      await axios.delete(
        `https://bebsa-backend.vercel.app/api/debit/${deleteId}`
      );
  ...
  const downloadTransactionsPDF = async () => {
    try {
      ...
      const headers = ["Company", "Amount", "Account Number"];
