...
const MobileAccounts = () => {
  ...
  const [updateSelectCompany, setUpdateSelectCompany] =
    useState("Nagad Personal");
  ...
  const fetchAccounts = async () => {
    try {
      ...
      const response = await axios.get(
        "https://bebsa-backend.vercel.app/api/mobileAccounts/account-datas",
        {
          params: params,
        }
      );
  ...
  const handleUpdateAccount = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://bebsa-backend.vercel.app/api/mobileAccounts/${updateAccountId}`,
        {
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      await axios.delete(
        ` https://bebsa-backend.vercel.app/api/mobileAccounts/${deleteAccountId}`
      );
              ...
              <div className="p-4">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={() =>
                      setExpandedRow(
                        expandedRow === account._id ? null : account._id
                      )
                    }
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <div className="mb-6">
              <p className="text-gray-700">
                Are you sure you want to delete the account with number{" "}
                <span className="font-semibold">{deleteAccountNumber}</span>?
